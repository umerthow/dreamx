		...
		********************************/
		...
		function setSize(img,opt) {
				...
				if (opt.fullScreen=="on") {
						...
						opt.container.css({'height':'400px;'});
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first').css({overflow:'hidden',width:'100%',height:'400px;',maxHeight:container.parent().css('maxHeight')});
			if (opt.autoHeight=="on") {
			   container.find('>ul:first').css({overflow:'hidden',width:'100%',height:'400px;',maxHeight:"none"});
			...
			container.find('>ul:first >li').each(function(j) {
				...
				li.css({'width':'100%','height':'400','overflow':'hidden'});
				...
				if (li.data('link')!=undefined) {
					...
					if (link=="slide") {
						li.append('<div class="tp-caption sft slidelink" style="width:100%;height:400px;z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a style="width:100%;height:400px;display:block"><span style="width:100%;height:400px;display:block"></span></a></div>');
					} else {
						linktoslide="no";
						li.append('<div class="tp-caption sft slidelink" style="width:100%;height:400px;z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a style="width:100%;height:400px;display:block" target="'+target+'" href="'+link+'"><span style="width:100%;height:400px;display:block"></span></a></div>');
					}
