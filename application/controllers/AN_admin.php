	...
	function kontak_masuk(){
	 ...
	 function subscribe_management(){
		...
		$data=array(
				...
				'npage'=>26,
				'burl'=>base_url()."admin",
				'subscribe'=>$this->main->get_subscribe()
				);
		$this->load->view('admin/header',$data);
		$this->load->view('admin/all_subscribe',$data);
		$this->load->view('admin/footer',$data);
		}
		
	}

	function export_subscribe(){
		$this->load->model("admin/main");

		$data=array(
				
				'burl'=>base_url()."AN_ajax_admin",
				'subscribe'=>$this->main->get_subscribe()
				);
		
		$this->load->view('admin/all_subscribe_xls',$data);
