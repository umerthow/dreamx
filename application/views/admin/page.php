      ...
      <div class="content-wrapper" >
        ...
        <section class="content">
          ...
          <div class="box box-warning">
              ...
              <div class="checkbox" >
                <label >
                  <input type="checkbox" value="" id="highlight" style="width:15px; height:15px;margin-bottom:15px;" <?php if( $data['highlight']==1){echo "checked";}else{ echo "";}  ?>>
                  Set Sebagai Highlights
                </label>
              </div>
