...
<div itemscope itemtype="http://schema.org/NewsArticle" class='artikel' style="margin-bottom: 10px;">
	...
	<div class='konten'>
		...
		<div class='info'>
			...
			echo "<span  itemprop='datePublished' content='".cuma_tanggal($artikel['tanggal'])."' class='tanggal'> ".format_tanggal($artikel['tanggal'])."</span>|  
...
<div class="col-md-12">
<p class="text-right"><small><i><?php echo set_tag($artikel['courtesy']) ?></i></small></p>
</div>
